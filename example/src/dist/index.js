...
var GladepayContext = React.createContext({
...
var GladepayProvider = function (_a) {
    ...
    var initializePayment = useGladepayPayment(others);
    return (React__default.createElement(GladepayContext.Provider, { value: { initializePayment: initializePayment, onSuccess: onSuccess, onClose: onClose } }, children));
};

var GladepayConsumerChild = function (_a) {
    var children = _a.children, ref = _a.ref;
    var _b = React.useContext(GladepayContext), initializePayment = _b.initializePayment, onSuccess = _b.onSuccess, onClose = _b.onClose;
...
var GladepayConsumer = React.forwardRef(function (_a, ref) {
    ...
    return (React__default.createElement(GladepayProvider, __assign({}, others, { onSuccess: onSuccess, onClose: onClose }),
        React__default.createElement(GladepayConsumerChild, { ref: ref }, children)));
});

exports.GladepayButton = GladepayButton;
exports.GladepayConsumer = GladepayConsumer;
exports.useGladepayPayment = useGladepayPayment;
